...
func init() {
	...
	// recoverfromcdc command.
	{
		...
		cliflagcfg.BoolFlag(f, &recoverfromcdcCtx.RecoverKafkaFanOutEnable, cliflags.RecoverKafkaFanOutEnable)
		cliflagcfg.StringFlag(f, &recoverfromcdcCtx.RecoverKafkaFanOutTargetBootstrapServer, cliflags.RecoverKafkaFanOutTargetBootstrapServer)
		cliflagcfg.StringFlag(f, &recoverfromcdcCtx.RecoverKafkaFanOutTargetTopicName, cliflags.RecoverKafkaFanOutTargetTopicName)
		cliflagcfg.StringFlag(f, &recoverfromcdcCtx.RecoverKafkaFanOutTargetCommandConfigFile, cliflags.RecoverKafkaFanOutTargetCommandConfigFile)
